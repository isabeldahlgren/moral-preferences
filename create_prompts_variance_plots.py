...
create_grouped_bar_plot(df, 'Total Variation Distance', 
                       'Total Variation Distance Across Various Prompts',
                       'Total Variation Distance',
                       'logs/variances_over_prompts/tvd_plot.png')

create_grouped_bar_plot(df, 'Jensen-Shannon Divergence',
                       'Jensen-Shannon Divergence Across Various Prompts',
                       'Jensen-Shannon Divergence',
                       'logs/variances_over_prompts/jsd_plot.png')

create_grouped_bar_plot(df, 'Rank Edit Distance',
                       'Rank Edit Distance Across Various Prompts',
                       'Rank Edit Distance',
                       'logs/variances_over_prompts/rank_edit_distance_plot.png')
