...
# Directory containing the runs variance CSV files
variances_dir = 'logs/variances_over_runs'
output_dir = 'logs/variances_over_runs'

# Find all variance CSV files in the runs directory
...
print(f"Runs variance summary table saved to {output_dir}/variance_metrics_table.csv")
